...
public class InstantiateNodes : MonoBehaviour
{
    ...
    //Node will be generated by this function
    public void GenerateNodes()
    {
        ...
        //This function is call when the button "Instantiate Node" is pressed
        //The previous nodes have to be destroy
        if (GameObject.Find("MyNodes") != null)
        {

            //Insantiate nodes if not another nodes are found
